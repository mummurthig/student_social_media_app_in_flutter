...
Future<List<Data>> fetchData() async {
  final response = await http.get(
      'https://helloworldhosur.000webhostapp.com/api/v2/all_events.php');
...
class _AllEventsState extends State<AllEvents> with AutomaticKeepAliveClientMixin<AllEvents> {
