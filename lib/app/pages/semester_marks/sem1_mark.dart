...
class Sem1MarkPage extends StatefulWidget {

  @override
  _Sem1MarkPageState createState() => _Sem1MarkPageState();
}
Future<List<Data>> fetchData() async {
  final response = await http.get(
      'https://helloworldhosur.000webhostapp.com/api/v2/getsemmark.php?student_id=1&sem=1');
...
class _Sem1MarkPageState extends State<Sem1MarkPage> with AutomaticKeepAliveClientMixin<Sem1MarkPage>{
