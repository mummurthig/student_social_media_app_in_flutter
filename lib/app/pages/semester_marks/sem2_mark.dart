...
class Sem2MarkPage extends StatefulWidget {
  @override
  _Sem2MarkPageState createState() => _Sem2MarkPageState();
}

Future<List<Data>> fetchData() async {
  final response = await http.get(
      'https://helloworldhosur.000webhostapp.com/api/v2/getsemmark.php?student_id=1&sem=2');
...
class _Sem2MarkPageState extends State<Sem2MarkPage> with AutomaticKeepAliveClientMixin<Sem2MarkPage>{
