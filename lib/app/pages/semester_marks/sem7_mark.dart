...
class Sem7MarkPage extends StatefulWidget {

  @override
  _Sem7MarkPageState createState() => _Sem7MarkPageState();
}


Future<List<Data>> fetchData() async {
  final response = await http.get(
      'https://helloworldhosur.000webhostapp.com/api/v2/getsemmark.php?student_id=1&sem=7');
...
class _Sem7MarkPageState extends State<Sem7MarkPage> with AutomaticKeepAliveClientMixin<Sem7MarkPage>{
