...
class Sem5MarkPage extends StatefulWidget {

  @override
  _Sem5MarkPageState createState() => _Sem5MarkPageState();
}


Future<List<Data>> fetchData() async {
  final response = await http.get(
      'https://helloworldhosur.000webhostapp.com/api/v2/getsemmark.php?student_id=1&sem=5');
...
class _Sem5MarkPageState extends State<Sem5MarkPage> with AutomaticKeepAliveClientMixin<Sem5MarkPage> {
